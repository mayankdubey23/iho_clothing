...
import { ArrowRight, BadgeCheck, Dumbbell, Store } from 'lucide-react';
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-[1fr_480px] xl:grid-cols-[1fr_540px]">
      ...
      <div className="relative hidden overflow-hidden bg-zinc-950 lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <motion.div className="relative" variants={stagger} initial="hidden" animate="visible">
          <motion.p
          ...
          >
            Join the
            <br />
            <span className="text-teal-400">IHO family</span>
          </motion.h1>
          <motion.p className="mt-5 max-w-sm text-base leading-7 text-zinc-400" variants={fadeUp}>
            One account for shopping premium activewear and applying for franchise opportunities.
          </motion.p>
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm font-medium text-stone-500">
              One account for shopping and franchise applications.
            </p>
          </div>
          ...
          <form onSubmit={submit} className="grid gap-4">
            ...
            <button
              disabled={processing}
              className="button-glow mt-1 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-zinc-900 px-5 text-sm font-bold text-white transition-colors hover:bg-zinc-800 disabled:opacity-60"
              type="submit"
            >
