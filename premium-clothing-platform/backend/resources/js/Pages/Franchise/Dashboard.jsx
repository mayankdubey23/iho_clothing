            ...
            <div className="max-w-[1600px] mx-auto pb-20 pt-6 px-4 sm:px-6">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
                    <div>
                        <h1 className="text-3xl font-black text-[#282c3f] uppercase tracking-tighter flex items-center gap-3">
                            <Activity className="text-[#ff3f6c]" size={32} /> Command Center
                        </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-2 bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                        <h3 className="text-sm font-black text-[#282c3f] uppercase tracking-widest mb-6">Sales Performance (Last 7 Days)</h3>
                        <div className="h-[300px] w-full">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={charts.salesTrend}>
                                    ...
                                    <Bar dataKey="sales" fill="#282c3f" radius={[6, 6, 0, 0]} barSize={40} />
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-[#282c3f] text-white rounded-3xl p-6 shadow-xl shadow-black/10">
                            ...
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <Package size={32} className="text-[#ff3f6c] opacity-80" />
                            </div>
                                ...
                                {charts.topProducts.map((prod, idx) => (
                                    <div key={idx} className="flex justify-between items-center">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <p className="font-bold text-[#282c3f] text-sm truncate max-w-[150px]">{prod.product_name}</p>
                                        </div>
                                        <span className="bg-gray-50 text-[#282c3f] px-2 py-1 rounded-md text-[10px] font-black uppercase tracking-widest">{prod.total_sold} Sold</span>
                                    </div>
                                ))}
...
function SmallMetric({ title, value, icon: Icon, color = "text-gray-400", alert }) {
    return (
        <div className={`bg-white p-4 rounded-2xl border ${alert ? 'border-red-200 bg-red-50/30' : 'border-gray-100'} shadow-sm text-center flex flex-col items-center justify-center`}>
            ...
            <h4 className="text-xl font-black text-[#282c3f] leading-none">{value}</h4>
